...
# ── Load GDP data ────────────────────────────────────────────────────────────
gdp = pd.read_csv(os.path.join(DATA_DIR, "gdppercapita_us_inflation_adjusted.csv"),
                   index_col="Country")

# Country names in World Bank data
CR_GDP_NAME = "Costa Rica"
KR_GDP_NAME = "Korea, Rep."

# ── Load WCDE lower secondary completion ─────────────────────────────────────
edu = pd.read_csv(os.path.join(PROC_DIR, "lower_sec_both.csv"), index_col="country")
...
# ── Write checkin ────────────────────────────────────────────────────────────
checkin = {
    "script": "scripts/verify_costa_rica_korea.py",
...
out_path = os.path.join(CHECKIN_DIR, "costa_rica_korea.json")
