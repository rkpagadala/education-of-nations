...
ax.set_title(
    "Figure 2. Generational β Varies With Baseline Education Level\n"
...
# Compute specific beta values needed by verify_paper_numbers.py
...
checkin = {
    "script": "scripts/fig_beta_vs_baseline.py",
...
checkin_path = os.path.join(CHECKIN_DIR, "fig_beta_vs_baseline.json")
