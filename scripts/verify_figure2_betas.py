...
Runs the same logic as scripts/fig_beta_vs_baseline.py and extracts
...
# ── Parameters (same as fig_beta_vs_baseline.py) ────────────────────────────
WINDOW_SIZE = 25
STEP = 10
LAG = 25
MIN_OBS = 3
...
# ── Countries (same as fig_beta_vs_baseline.py) ─────────────────────────────
COUNTRIES = [
...
# ── Write checkin ────────────────────────────────────────────────────────────
checkin = {
    "script": "scripts/verify_figure2_betas.py",
...
out_path = os.path.join(CHECKIN_DIR, "figure2_betas.json")
