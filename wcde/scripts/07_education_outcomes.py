...
def _safe_coef(result_tuple, key):
    """Extract coefficient from (coefs_dict, r2, n) tuple."""
...
checkin = {
    "script": "wcde/scripts/07_education_outcomes.py",
    "produced": pd.Timestamp.now().strftime("%Y-%m-%d"),
    "numbers": checkin_numbers,
}
checkin_path = os.path.join(CHECKIN_DIR, "education_outcomes.json")
